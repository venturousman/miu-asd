...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println("=======================================================================================.");
		System.out.println("The customer with the lowest age first, then the customer with the 2nd lowest age, etc.");
		...
		Predicate<Customer> fromChicagoPredicate = c -> c.getAddress().getCity().equalsIgnoreCase("Chicago");
		Iterator<Customer> filterIterator = customerCollection.filterIterator(fromChicagoPredicate);
		...
		Predicate<Customer> zipCode12Predicate = c -> c.getAddress().getZip().startsWith("12");
		filterIterator = customerCollection.filterIterator(zipCode12Predicate);
		while (filterIterator.hasNext()) {
			System.out.println(filterIterator.next());
		}

		System.out.println("=======================================================================================.");
		System.out.println("After every customer it skips the next customer.");
		Iterator<Customer> alternateIterator = customerCollection.alternateCustomerIterator();
